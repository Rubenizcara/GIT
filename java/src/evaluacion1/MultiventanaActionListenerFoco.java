...
public class MultiventanaActionListenerFoco extends JFrame implements ActionListener{
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					MultiventanaActionListenerFoco frame = new MultiventanaActionListenerFoco();
	 ...
	 * Create the frame.
	 */
	public MultiventanaActionListenerFoco() {
		setResizable(false);
